...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable UDP hole punching", "Habilitar perfuração UDP"),
        ...
        ("New tab", "Nova aba"),
        ("Keep terminal sessions on disconnect", "Manter sessões de terminal desconectadas"),
        ...
        ("Show my cursor", "Exibir meu cursor"),
        ...
        ("Alias", "Apelido"),
        ("ScrollEdge", "Borda de rolagem"),
        ("Allow insecure TLS fallback", "Permitir fallback TLS inseguro"),
        ("allow-insecure-tls-fallback-tip", "Por padrão, o RustDesk verifica o certificado do servidor para protocolos que utilizam TLS.\nCom esta opção ativada, o RustDesk ignorará a etapa de verificação e prosseguirá em caso de falha na verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve usar apenas TCP.\nQuando esta opção está ativada, o RustDesk não usará mais a porta UDP 21116, e sim a porta TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: O servidor RustDesk OSS não inclui esse recurso."),
        ("input note here", ""),
